...
<div class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 px-4">
  <div class="bg-white p-8 sm:p-12 rounded-lg shadow-xl w-full max-w-screen-lg mx-auto text-center">
    <h1 class="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6 sm:mb-8">Welcome to AppyDave</h1>
...
def require_authentication
  ...
  def fix_authentication_signout_edge_case
    gsub_file 'app/controllers/concerns/authentication.rb', /Current.session.destroy/m, 'Current.session&.destroy'
  end
end
...
# { id: 2, label: 'Flash', customizations: add_flash_messages } },
# { id: 3, label: 'Authentication', customizations: run_auth_actions } },
